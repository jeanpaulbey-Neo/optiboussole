  ...
  sections: [
    ...
    },
    {
      ...
      blocs: [
        ...
        "**Sauf pour les tirages tout ou rien**, et c’est une exception qu’il a fallu corriger. Un événement qui arrive ou n’arrive pas n’a pas de médiane qui veuille dire quelque chose : la sienne vaut « il n’arrive pas ». Balayer avec elle, c’est chercher le seuil **en supposant le sinistre écarté** — et les seuils de « ce projet sera-t-il prêt à temps ? » étaient calculés sans l’incident hors planning, dans un modèle dont c’est justement le sujet.",
        "Ces tirages-là sont donc rejoués, sur une suite régulière, et le résultat est moyenné. Le seuil porte alors sur l’espérance de chaque branche — la grandeur que le verdict compare. Sur « réparer ou remplacer ? », le seuil de la durée de vie après réparation est passé de 2,9 à 4,2 années le jour où la rechute a cessé d’être supposée absente.",
      ],
    },
    {
