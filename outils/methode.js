  ...
  sections: [
    {
      ...
      blocs: [
        ...
        "```\nloyer = 900 à 1150\n```",
        "De cette fourchette, le site tire une loi de probabilité. Si les deux bornes sont positives, c’est une **lognormale**. Sa **médiane** — le chiffre que la vraie valeur dépasse une fois sur deux — est la moyenne *géométrique* des bornes, et non leur demi-somme.",
        "```\nx = 100 à 400\n```",
        "> une fois sur deux en dessous de 200, et non de 250. Neuf tirages sur dix tombent entre 100 et 400, aucun n’est négatif.",
    ...
    },
    {
      ...
      blocs: [
        ...
        "> Sur « louer ou acheter » : quand « Acheter » l’emporte — 6 fois sur 10 —, c’est au moins **36 k€** de mieux une fois sur deux. Quand « Louer » aurait été meilleur — 4 fois sur 10 —, c’est au moins **26,3 k€** de moins une fois sur deux, et jusqu’à **78,3 k€** dans le pire vingtième de ces cas-là.",
