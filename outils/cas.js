  ...
  sections: [
    ...
    },
    {
      ...
      blocs: [
        ...
        "```\nx = 100 à 400\n```",
        "> le chiffre du milieu est 200, et non 250 : une fois sur deux en dessous, une fois sur deux au-dessus.",
        "Ce chiffre du milieu est la moyenne *géométrique* des deux bornes, et non leur demi-somme. C’est voulu : sur un prix, une durée, un nombre de pannes, se tromper d’un facteur deux vers le haut est aussi plausible que vers le bas — pas de 150 € dans les deux sens. Sur `400 à 1800`, il tombe donc à 845 €, et non à 1 100. Le repère pointillé de chaque fourchette affichée le montre : il est visiblement à gauche du centre.",
      ],
    },
    {
      ...
      blocs: [
        ...
        "> **Ce que vous jouez.** Quand « Garder l’actuelle » l’emporte — 7 fois sur 10 —, c’est au moins 2 776 € de mieux une fois sur deux. Quand l’autre branche aurait été meilleure — 3 fois sur 10 —, c’est au moins 1 920 € de moins une fois sur deux, et jusqu’à 7 650 € dans le pire vingtième de ces cas-là.",
